    ...
    <Layout>
      <div className="h-screen justify-center items-center flex flex-col gap-y-4">
        <button
          ...
          } px-3 py-2 transition duration-300 ease-in-out  hover:-translate-y-1`}
        >
        ...
        <Card className="justify-center items-center flex flex-col gap-y-4 rounded-sm">
              ...
              <div className="flex flex-row justify-center">
                <Button
                  ...
                  className={`mt-2 rounded-md ${
                    (colorMap.PRIMARY_DARK, backgroundColorMap.TEAL)
                  } font-semibold px-3 py-2 font-semibold transition duration-300 ease-in-out  hover:-translate-y-1`}
                >
                ...
                {formError && (
                  <>
                    <Button
                      ...
                      className={`mt-2 rounded-md ${
                        (colorMap.PRIMARY_DARK, backgroundColorMap.TEAL)
                      } font-semibold px-3 py-2 font-semibold transition duration-300 ease-in-out  hover:-translate-y-1 ml-2`}
                    >
                      Sign up?
                    </Button>
                  </>
