...
class Mailer {
  private readonly from: string = "OrbitalMemo <info@orbitalmemo.com>";
  private devMail: Transporter | null;

  constructor() {
    this.devMail = IS_PRODUCTION
      ? null
      : nodemailer.createTransport(DEV_EMAIL_OPTIONS);
  }
